...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Welcome Popup (shows once on load for a few seconds)
    function showWelcomePopup() {
        const overlay = document.createElement('div');
        overlay.className = 'welcome-overlay';
        overlay.innerHTML = `
            <div class="welcome-popup">
                <button class="welcome-close" aria-label="Close welcome message">&times;</button>
                <div class="welcome-icon"><i class="fas fa-shield-alt"></i></div>
                <h2>Welcome to my Cyber Security Portfolio</h2>
                <p>Explore my work in security auditing, threat hunting, and secure development.</p>
            </div>
        `;
    ...
    // Cursor Reactive Background (for all sections)
    let mouseX = 50;
    let mouseY = 50;
    let cursorRaf = null;

    function updateCursorBackground() {
    ...
    function init() {
        ...
        // Show simple welcome pop-up after a short delay
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', function (e) {
            ...
            // Build email to send via user's default mail client
            const to = 'cdaksh4502@gmail.com';
            ...
            showNotification('Your email client should open shortly to send the message.', 'success');
